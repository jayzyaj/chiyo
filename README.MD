A **React Native** starter kit or boilerplate for starting a project with the help of **redux, redux-saga** for state management, **react-native elements** and **nativebase** for building the UI components and **react-navigation-v3** for the routing or navigation.
...
1. Clone the project repository `https://github.com/jayzyaj/chiyo`
